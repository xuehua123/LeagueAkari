/**
 * AUTO-GENERATED FILE FROM RIOT DATA DRAGON 16.17.1
 * Source URL: https://ddragon.leagueoflegends.com/cdn/16.17.1/data/zh_CN/item.json
 * Data Dragon Source SHA-256: aff335136e1dc3429655efc763460b9a55630ce8ba27522654070a6beb239973
 * DO NOT MANUALLY EDIT THIS FILE! Use scripts/generate-live-coach-catalog-16-17-1.mjs instead.
 */
...
export const RiotItemCatalog16_17_1: RiotItemCatalog = {
  version: '16.17.1',
  sourceSha256: 'aff335136e1dc3429655efc763460b9a55630ce8ba27522654070a6beb239973',
  items: {
    '1001': {
      id: 1001,
      name: '鞋子',
    ...
    '1018': {
      ...
      purchasable: true,
      from: [],
      into: [123430, 667666, 3031, 3086, 6670, 3033, 3039, 3508, 3095, 6676],
      tags: ['CriticalStrike']
    },
    '1026': {
      id: 1026,
    ...
    '1028': {
      ...
      from: [],
      into: [
        3742, 1011, 3068, 2021, 323222, 323075, 326617, 323107, 3012, 3147, 3067, 3211, 2502,
        322526, 2526, 3023, 3044, 3053, 3066, 3075, 3152, 3161, 3801, 3803, 4401, 4635, 6035, 6660,
        6662
      ],
      tags: ['Health']
    },
    ...
    '1038': {
      ...
      purchasable: true,
      from: [],
      into: [3031, 3026, 3032, 3072, 3095, 4403, 6671],
      tags: ['Damage']
    },
    '1042': {
      id: 1042,
    ...
    '2022': {
      ...
      purchasable: true,
      from: [],
      into: [2020, 3024, 3133, 3802, 3067, 3057, 3108, 3158, 4642, 6660],
    ...
    '3144': {
      ...
      purchasable: true,
      from: [1042, 1042],
      into: [2512, 3094, 3087, 3032, 3085, 3095],
      tags: ['AttackSpeed']
    },
    '3145': {
      id: 3145,
